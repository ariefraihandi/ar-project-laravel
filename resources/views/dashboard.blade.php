                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="text-container">
                                        ...
                                        <a class="btn-solid-reg popup-with-move-anim" href="#details-lightbox-1">Daftar Biaya</a>
        ...
        <div class="container">
            <div id="pricing" class="cards-2">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="above-heading">Biaya Pembuatan Makalah</div>
                            <h2 class="h2-heading">Daftar Biaya</h2>
                        </div> <!-- end of col -->
                    </div> <!-- end of row -->
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="price"><span class="currency">Rp</span><span class="value">200.000</span></div>
                                    <div class="frequency">Sekali Pembelian</div>
                                    <div class="divider"></div>
                                    <ul class="list-unstyled li-space-lg">
                                        <li class="media">
                                            <i class="fas fa-check"></i><div class="media-body">Jumlah Halaman: 5 – 15</div>
                                        </li>
                                        <li class="media">
                                            <i class="fas fa-check"></i><div class="media-body">Jumlah Referensi: 5 – 10</div>
                                        </li>
                                        <li class="media">
                                            <i class="fas fa-times"></i><div class="media-body">Plagiasi Checking</div>
                                        </li>
                                    </ul>
                                    <div class="button-wrapper">
                                        <a class="btn-solid-reg page-scroll" href="{{ route('regis.page') }}">Buat Akun</a>
                                    </div>
                                </div>
                            </div>
