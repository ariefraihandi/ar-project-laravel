...
@endforeach
      ...
      {{-- @foreeach ($menu as $parent)
        ...
        <li class="menu-item {{ $submenu['itemsub'] == 1 ? 'active' : '' }}">
            @if ($submenu['itemsub'] == 1)
            <a href="javascript:void(0);" class="menu-link menu-toggle">
            @else
            ...
            @if (!empty($submenu['childSubmenus']))
            <ul class="menu-sub">
                @foreach ($submenu['childSubmenus'] as $childSubmenuId => $childSubmenu)
                <li class="menu-item">
                    <a href="{{ $childSubmenu['url'] }}" class="menu-link">
                        <div data-i18n="{{ $childSubmenu['name'] }}">{{ $childSubmenu['name'] }}</div>
                    </a>
                </li>
                @endforeach
            </ul>
